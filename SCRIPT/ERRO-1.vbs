For i = 1 To 7
    ...
    session.findById("wnd[0]/usr/ctxt[10]").text = InputBox("Insira o  número da nota")
    session.findById("wnd[0]/usr/ctxt[10]").setFocus
    session.findById("wnd[0]/usr/ctxt[10]").caretPosition = 8
    session.findById("wnd[0]").sendVKey 0
    session.findById("wnd[0]/usr/cntlTEDITOR/shellcont/shell").setSelectionIndexes 36,36
